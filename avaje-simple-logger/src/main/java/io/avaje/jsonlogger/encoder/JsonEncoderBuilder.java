...
final class JsonEncoderBuilder {
    ...
    private ShortenedThrowableConverter throwableConverter = new ShortenedThrowableConverter();
    ...
    JsonEncoderBuilder throwableConverter(ShortenedThrowableConverter throwableConverter) {
