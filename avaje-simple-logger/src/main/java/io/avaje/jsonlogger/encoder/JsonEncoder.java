...
final class JsonEncoder {
  ...
  private final ShortenedThrowableConverter throwableConverter;
  ...
  JsonEncoder(JsonStream json, String component, String environment, StackHasher stackHasher, DateTimeFormatter formatter, boolean includeStackHash, Map<String, String> customFieldsMap, ShortenedThrowableConverter throwableConverter) {
    this.json = json;
