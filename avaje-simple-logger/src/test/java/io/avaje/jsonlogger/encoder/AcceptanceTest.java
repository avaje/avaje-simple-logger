...
import io.avaje.jsonlogger.LoggerTestSuite;
...
public class AcceptanceTest extends LoggerTestSuite {
    ...
    public Logger createLogger(ListAppendingOutputStream outputStream, Level level) {
        Abbreviator abbreviator = Abbreviator.NOOP;
        int logLevel = Bootstrap.stringToLevel(level.toString());
        return new SimpleLogger(new PlainLogWriter(System.out, abbreviator, true), "TestSuiteLogger", logLevel);
    }
